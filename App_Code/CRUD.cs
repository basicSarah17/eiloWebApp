   ...
   public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["eiloConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["eiloConStr"].ConnectionString);
        public CRUD()
        {
            //
